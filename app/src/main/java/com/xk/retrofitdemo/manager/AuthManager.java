...
//				if( hid != null ){
//					int len = hid.length();
//					int cunnretLen = 40 - len;
//					StringBuilder sBuilder = new StringBuilder(hid);
//					for (int i = 0; i < cunnretLen; i++) {
//						sBuilder.append("0");
//					}
//					hid = sBuilder.toString();
//				}
//
...
//	}
//
//	public Ad getPlayUrl40(String aid, String mclassify, String sid, String msid, String mid,String mtype,
//			String pid, String playtype, String adversion, String adurl, String playUrlVersion,
//			String authInterfaceVersion, String apptype, String jumpplay, String channelCode, String deduct) {
//		String httpMessage = "";
//		int retryTimes = 2;
//		for(int i=0; i<retryTimes; i++){
//			String url = formatAuthPlayUrl40(aid, mclassify, sid, msid, mid, mtype,pid, playtype, adversion, adurl, playUrlVersion, authInterfaceVersion, apptype, jumpplay, channelCode, deduct);
//			StringBuffer buffer = new StringBuffer();
//			if (NetUtil.connectServer(url, buffer, 1, 6)) {
//				httpMessage = buffer.toString();
...
//	 * @param adversion
//	 * @param adurl
//	 * @param playUrlVersion
//	 * @param authInterfaceVersion
//	 * @param apptype
//	 * @param jumpplay
//	 * @param channelCode
//	 * @param deduct
//	 * @return
//	 */
//	public String formatAuthPlayUrl40(String aid, String mclassify, String sid, String msid, String mid,String mtype,
//			String pid, String playtype, String adversion, String adurl, String playUrlVersion,
//			String authInterfaceVersion, String apptype, String jumpplay, String channelCode, String deduct) {
//		StringBuffer sb = new StringBuffer();
//		sb.append("{\"action\":\"playauth\",");
